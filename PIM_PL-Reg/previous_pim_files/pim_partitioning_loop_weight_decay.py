...
def main():
    ...
    # ema.apply_shadow()
    print(f'PIM training is completed! weight_decay {w} H_unseen_score {h_u_cond_l_loss.item(), h_u_loss.item(), ce_l_loss.item(), h_u_l_cond_y.item(), loss.item(), H_labelled.item(), H_unlabelled.item() }\n ')
    print(running_loss)
